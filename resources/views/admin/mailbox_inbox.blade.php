				  ...
				  <div class="table-responsive">
					<table class="table no-border">
					  ...
					  <tr>
						...
						<td class="w-80"><a href="#"><img class="avatar" src="{{ asset('adminassets')}}/images/avatar/2.jpg" alt="..."></a></td>
					  ...
					  <tr>
						...
						<td class="w-80"><a href="#"><img class="avatar" src="{{ asset('adminassets')}}/images/avatar/3.jpg" alt="..."></a></td>
					  ...
					  <tr>
						<td><input type="checkbox"></td>
						<td class="mailbox-star"><a href="#"><i class="fa fa-star-o text-warning"></i></a></td>
						<td class="w-80"><a href="#"><img class="avatar" src="{{ asset('adminassets')}}/images/avatar/4.jpg" alt="..."></a></td>
					  ...
					  <tr>
						<td><input type="checkbox"></td>
						<td class="mailbox-star"><a href="#"><i class="fa fa-star text-warning"></i></a></td>
						<td class="w-80"><a href="#"><img class="avatar" src="{{ asset('adminassets')}}/images/avatar/5.jpg" alt="..."></a></td>
					 ...
					 <tr>
						<td><input type="checkbox"></td>
						<td class="mailbox-star"><a href="#"><i class="fa fa-star text-warning"></i></a></td>
						<td class="w-80"><a href="#"><img class="avatar" src="{{ asset('adminassets')}}/images/avatar/6.jpg" alt="..."></a></td>
					  ...
					  <tr>
						<td><input type="checkbox"></td>
						<td class="mailbox-star"><a href="#"><i class="fa fa-star-o text-warning"></i></a></td>
						<td class="w-80"><a href="#"><img class="avatar" src="{{ asset('adminassets')}}/images/avatar/7.jpg" alt="..."></a></td>
					  ...
					  <tr>
						<td><input type="checkbox"></td>
						<td class="mailbox-star"><a href="#"><i class="fa fa-star-o text-warning"></i></a></td>
						<td class="w-80"><a href="#"><img class="avatar" src="{{ asset('adminassets')}}/images/avatar/8.jpg" alt="..."></a></td>
					  ...
					  <tr>
						<td><input type="checkbox"></td>
						<td class="mailbox-star"><a href="#"><i class="fa fa-star text-warning"></i></a></td>
						<td class="w-80"><a href="#"><img class="avatar" src="{{ asset('adminassets')}}/images/avatar/9.jpg" alt="..."></a></td>
					  ...
					  <tr>
						<td><input type="checkbox"></td>
						<td class="mailbox-star"><a href="#"><i class="fa fa-star text-warning"></i></a></td>
						<td class="w-80"><a href="#"><img class="avatar" src="{{ asset('adminassets')}}/images/avatar/1.jpg" alt="..."></a></td>
					  ...
					  <tr>
						<td><input type="checkbox"></td>
						<td class="mailbox-star"><a href="#"><i class="fa fa-star-o text-warning"></i></a></td>
						<td class="w-80"><a href="#"><img class="avatar" src="{{ asset('adminassets')}}/images/avatar/default.jpg" alt="..."></a></td>
