						  ...
						  <div id="chat-contact" class="media-list media-list-hover media-list-divided ">
							<div class="media media-single">
							  <a href="#" class="avatar avatar-lg status-success">
								<img src="{{asset('adminassets')}}/images/avatar/2.jpg" alt="...">
							  </a>
							...
							<div class="media media-single">
							  <a href="#" class="avatar avatar-lg status-success">
								<img src="{{asset('adminassets')}}/images/avatar/1.jpg" alt="...">
							  </a>
							...
							<div class="media media-single">
							  <a href="#" class="avatar avatar-lg status-success">
								<img src="{{asset('adminassets')}}/images/avatar/3.jpg" alt="...">
							  </a>
							...
							<div class="media media-single">
							  <a href="#" class="avatar avatar-lg status-success">
								<img src="{{asset('adminassets')}}/images/avatar/4.jpg" alt="...">
							  </a>
							...
							<div class="media media-single">
							  <a href="#" class="avatar avatar-lg status-success">
								<img src="{{asset('adminassets')}}/images/avatar/5.jpg" alt="...">
							  </a>
							...
							<div class="media media-single">
							  <a href="#" class="avatar avatar-lg status-success">
								<img src="{{asset('adminassets')}}/images/avatar/7.jpg" alt="...">
							  </a>
						...
						<div class="box-body">
						  ...
						  <div id="chat-app" class="direct-chat-messages chat-app">
							...
							<div class="direct-chat-msg mb-30">
							  ...
							  <!-- /.direct-chat-info -->
							  <img class="direct-chat-img avatar" src="{{asset('adminassets')}}/images/user1-128x128.jpg" alt="message user image">
							  <!-- /.direct-chat-img -->
							  ...
							  <div class="direct-chat-text">
								...
								<p class="popup-gallery">
									<a href="../images/gallery/thumb/4.jpg" title="Caption. Can be aligned to any side and contain any HTML.">
										<img src="{{asset('adminassets')}}/images/gallery/thumb/4.jpg" width="32.5%" alt="" />
									</a>
									<a href="../images/gallery/thumb/5.jpg" title="This image fits only horizontally.">
										<img src="{{asset('adminassets')}}/images/gallery/thumb/5.jpg" width="32.5%" alt="" />
									</a>
									<a href="../images/gallery/thumb/6.jpg">
										<img src="{{asset('adminassets')}}/images/gallery/thumb/6.jpg" width="32.5%" alt="" />
									</a>
								</p>
								<p class="direct-chat-timestamp"><time datetime="2018">00:09</time></p>
							  </div>					
