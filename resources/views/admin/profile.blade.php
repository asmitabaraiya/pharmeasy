			  ...
			  <div class="col-12 col-lg-5 col-xl-4">
				  ...
				  <div class="box box-inverse bg-img" style="background-image: url(../images/gallery/full/1.jpg);" data-overlay="2">
					  ...
					  <div class="box-body text-center pb-50">
						<a href="#">
						  <img class="avatar avatar-xxl avatar-bordered" src="{{ asset('adminassets')}}/images/avatar/5.jpg" alt="">
						</a>
				 ...
				 <div class="box box-widget widget-user">
					...
					<div class="widget-user-image">
					  <img class="rounded-circle" src="{{ asset('adminassets')}}/images/user3-128x128.jpg" alt="User Avatar">
					</div>
				...
				<div class="box">
					<div class="box-body">
						...
						<div class="gap-items-2 gap-y">
						  <a class="avatar" href="#"><img src="{{ asset('adminassets')}}/images/avatar/1.jpg" alt="..."></a>
						  <a class="avatar" href="#"><img src="{{ asset('adminassets')}}/images/avatar/3.jpg" alt="..."></a>
						  <a class="avatar" href="#"><img src="{{ asset('adminassets')}}/images/avatar/4.jpg" alt="..."></a>
						  <a class="avatar" href="#"><img src="{{ asset('adminassets')}}/images/avatar/5.jpg" alt="..."></a>
						  <a class="avatar" href="#"><img src="{{ asset('adminassets')}}/images/avatar/6.jpg" alt="..."></a>
						  <a class="avatar" href="#"><img src="{{ asset('adminassets')}}/images/avatar/7.jpg" alt="..."></a>
						  <a class="avatar" href="#"><img src="{{ asset('adminassets')}}/images/avatar/8.jpg" alt="..."></a>
				 ...
				 <div class="active tab-pane" id="usertimeline">
					...
					<div class="box">
					  <div class="media bb-1 border-fade">
						<img class="avatar avatar-lg" src="{{ asset('adminassets')}}/images/avatar/3.jpg" alt="...">
					  ...
					  <div class="media-list media-list-divided bg-lighter">
						<div class="media">
						  <a class="avatar" href="#">
							<img src="{{ asset('adminassets')}}/images/avatar/6.jpg" alt="...">
						  </a>
						  <div class="media-body">
							<p>
							...
							<div class="media px-0 mt-20">
							  <a class="avatar" href="#">
								<img src="{{ asset('adminassets')}}/images/avatar/8.jpg" alt="...">
							  </a>
							  <div class="media-body">
								<p>
						...
						<div class="media">
						  <a class="avatar" href="#">
							<img src="{{ asset('adminassets')}}/images/avatar/9.jpg" alt="...">
						  </a>
						  <div class="media-body">
							<p>
					  ...
					  <form class="publisher bt-1 border-fade">
						<img class="avatar avatar-sm" src="{{ asset('adminassets')}}/images/avatar/4.jpg" alt="...">
							...
							<div class="timeline-item">
								...
								<div class="timeline-event">
									...
									<div class="timeline-body">
										<img src="{{ asset('adminassets')}}/images/150x100.png" alt="..." class="m-10">
										<img src="{{ asset('adminassets')}}/images/150x100.png" alt="..." class="m-10">
										<img src="{{ asset('adminassets')}}/images/150x100.png" alt="..." class="m-10">
										<img src="{{ asset('adminassets')}}/images/150x100.png" alt="..." class="m-10">
									</div>
				  ...
				  <div class="tab-pane" id="activity">			
					...
					<div class="post">
					  <div class="user-block">
						<img class="img-bordered-sm rounded-circle" src="{{ asset('adminassets')}}/images/user1-128x128.jpg" alt="user image">
							<span class="username">
							  <a href="#">Brayden</a>
					...
					<div class="post">
					  <div class="user-block">
						<img class="img-bordered-sm rounded-circle" src="{{ asset('adminassets')}}/images/user6-128x128.jpg" alt="user image">
							<span class="username">
							  <a href="#">Evan</a>
							  <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
							</span>
					  ...
					  <div class="activitytimeline">
						  <div class="row mb-20">
							<div class="col-sm-6">
							  <img class="img-fluid" src="{{ asset('adminassets')}}/images/photo1.png" alt="Photo">
							</div>
							<!-- /.col -->
							<div class="col-sm-6">
							  <div class="row">
								<div class="col-sm-6">
								  <img class="img-fluid" src="{{ asset('adminassets')}}/images/photo2.png" alt="Photo">
								  <br><br>
								  <img class="img-fluid" src="{{ asset('adminassets')}}/images/photo3.jpg" alt="Photo">
								</div>
								<!-- /.col -->
								<div class="col-sm-6">
								  <img class="img-fluid" src="{{ asset('adminassets')}}/images/photo4.jpg" alt="Photo">
								  <br><br>
								  <img class="img-fluid" src="{{ asset('adminassets')}}/images/photo1.png" alt="Photo">
								</div>
								<!-- /.col -->
					...
					<div class="post clearfix">
					  <div class="user-block">
						<img class="img-bordered-sm rounded-circle" src="{{ asset('adminassets')}}/images/user7-128x128.jpg" alt="user image">
							<span class="username">
							  <a href="#">Nicholas</a>
							  <a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
							</span>
